...
# Configuration Script – DDM-123 - Rev. A

This **Configuration** script is designed for the **DDM-123** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – DDM-123 Rev. A

Este script de **Configuration** está diseñado para el modelo **DDM-123** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
